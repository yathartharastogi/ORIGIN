...
export default function Register() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#05070a] px-4 py-10">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[550px] w-[550px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-500/[0.06] blur-[120px]" />
      ...
      >
        ...
        <Card className="border-white/[0.08] bg-white/[0.025] backdrop-blur-xl">
          <CardContent className="p-6 sm:p-8">
            ...
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Start investigating payment anomalies.
              </p>
            </div>
